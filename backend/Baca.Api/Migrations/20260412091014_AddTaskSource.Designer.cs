...
namespace Baca.Api.Migrations
{
    ...
    [Migration("20260412091014_AddTaskSource")]
    partial class AddTaskSource
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Baca.Api.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Baca.Api.Models.TaskImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Baca.Api.Models.User", b =>
                {
                    ...
                    b.HasIndex("RegistraceUserId")
                        .IsUnique()
                        .HasFilter("\"RegistraceUserId\" IS NOT NULL");
            ...
            modelBuilder.Entity("Baca.Api.Models.TaskImage", b =>
                {
                    ...
                    b.HasOne("Baca.Api.Models.User", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskTag", b =>
                {
                    b.HasOne("Baca.Api.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Baca.Api.Models.TaskItem", null)
                        .WithMany()
